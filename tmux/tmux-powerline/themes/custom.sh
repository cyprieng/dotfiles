...
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR="#c8d3f5"
...
if [ -z "$TMUX_POWERLINE_WINDOW_STATUS_FORMAT" ]; then
  TMUX_POWERLINE_WINDOW_STATUS_FORMAT=(
    ...
    "#[fg=#82aaff,bg=#3B4261] #{?#{==:#F,-},#[nodim],#[dim]} #I #W #[nodim]"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
  TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
    ...
    "battery default_bg_color default_fg_color ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
