...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
  TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
    ...
    #"mailcount 9 255"
    # "now_playing ${TMUX_POWERLINE_RIGHT_BACKGROUND_COLOR} ${TMUX_POWERLINE_RIGHT_FOREGROUND_COLOR}"
    #"cpu 240 136"
    #"load 237 167"
    #"tmux_mem_cpu_load 234 136"
    "battery_custom ${TMUX_POWERLINE_RIGHT_BACKGROUND_COLOR} ${TMUX_POWERLINE_RIGHT_FOREGROUND_COLOR}"
    "cpu_percent ${TMUX_POWERLINE_RIGHT_BACKGROUND_COLOR} ${TMUX_POWERLINE_RIGHT_FOREGROUND_COLOR} ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
