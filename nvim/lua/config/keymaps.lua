...
-- Window navigation
vim.keymap.set("n", "<leader><Right>", "<C-w><Right>", { desc = "Go to right window", remap = true })
vim.keymap.set("n", "<leader><Left>", "<C-w><Left>", { desc = "Go to left window", remap = true })
vim.keymap.set("n", "<leader><Up>", "<C-w><Up>", { desc = "Go to upper window", remap = true })
vim.keymap.set("n", "<leader><Down>", "<C-w><Down>", { desc = "Go to lower window", remap = true })
...
vim.keymap.set("v", "<A-Right>", "w", { noremap = true })
vim.keymap.set("v", "<A-Left>", "b", { noremap = true })
